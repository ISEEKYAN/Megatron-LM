...
_FULL_PARALLEL_STEPS = int(os.environ.get("MLITE_MFSDP_DIAGNOSTIC_STEPS", "50"))
_FULL_PARALLEL_CURVE_INTERVAL = min(10, _FULL_PARALLEL_STEPS)
_FULL_PARALLEL_MICROBATCHES = int(
    os.environ.get("MLITE_MFSDP_DIAGNOSTIC_MICROBATCHES", "2")
)

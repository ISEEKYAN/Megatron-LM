...
| M-FSDP precision/performance/checkpoint/export/offload | `unit/primitive/test_mfsdp.py`, `unit/primitive/test_checkpoint_runtime.py`, `unit/runtime/test_runtime_backend_unit.py` | `smoke/primitive/test_mfsdp_parity_smoke.py` via `run_mfsdp_hopper_validation.sh` (8-GPU throughput; 8-GPU TP2/EP2/ETP1/PP2/CP2 50-step precision curve; two-process functional checkpoint/resume, HF export, and offload gate) |

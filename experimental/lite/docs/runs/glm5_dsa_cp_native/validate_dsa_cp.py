...
def main():
    ...
    # Keep CP-native correctness and memory evidence observable even while the
    # independent HF parity leg is being diagnosed.
    result["hf_reference"] = {"logits_cosine": _hf_reference_logits(rank, world)}
    gathered = [None] * world

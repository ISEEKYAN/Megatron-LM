...
Single-rank, DP=2, and fixed-proxy EP=2 MLite runtime scratch training are assembled and validated. EP uses explicitly reviewed bounds only for the pinned three-step proxy below. TP/ETP/CP/PP, full HF loading, and end-to-end external-reference parity remain unvalidated.

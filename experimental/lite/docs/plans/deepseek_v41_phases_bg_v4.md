...
is an acceptance criterion. Global loss normalization remains OPEN (O16).
...
This summary is not an exhaustive count of unknowns. Retain the and fail if another unresolved field appears during manifest consumption:
...
| 12 visual stages | 11 | C4 construction; F3 sync/freeze exceptions/unfreeze and E5v restore |

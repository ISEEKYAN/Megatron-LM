...
export ROLLOUT_TP=1 ROLLOUT_TEMPERATURE=1 ROLLOUT_GPU_MEMORY_UTILIZATION=0.3
export ROLLOUT_MAX_NUM_SEQS=4 ROLLOUT_MAX_NUM_BATCHED_TOKENS=128
export ROLLOUT_MAX_MODEL_LEN=12288
export SAVE_FREQ=-1 TEST_FREQ=-1 RESUME_MODE=disable TOTAL_TRAINING_STEPS=2
export VLLM_BATCH_INVARIANT=1 VERL_ACTOR_BATCH_INVARIANT=1
# This BF16 Nemotron path does not use the DS4 FP8 DeepGEMM backend.
export VLLM_USE_DEEP_GEMM=0
export VLLM_USE_V2_MODEL_RUNNER=1
export VERL_ROLLOUT_BATCH_INVARIANT=1 VERL_FULL_DETERMINISM=1
export VERL_REQUIRE_BITWISE_LOGPROBS=1

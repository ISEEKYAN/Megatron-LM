...
EMERGING_OPT_ROOT="${EMERGING_OPT_ROOT:-$RUN_ROOT/../task-1-13-5-5-3-muon-precision/emerging-opt-site-nodeps}"
BASE_IMAGE="${BASE_IMAGE:-$BASE/verl_optimize/verl.vllm023.sqsh}"
VERL_DSA_SITE="${VERL_DSA_SITE:-}"

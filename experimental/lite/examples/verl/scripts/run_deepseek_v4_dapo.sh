...
ALGORITHM=( "algorithm.adv_estimator=grpo" "algorithm.use_kl_in_reward=${USE_KL_IN_REWARD}" "algorithm.kl_ctrl.kl_coef=${KL_COEF:-0.0}" "algorithm.rollout_correction.bypass_mode=True" "algorithm.norm_adv_by_std_in_grpo=False" )

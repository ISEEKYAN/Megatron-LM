...
case "${ROLLOUT_WEIGHT_BITS}" in
  4) ROLLOUT_EXPERT_DTYPE=fp4; ROLLOUT_MOE_BACKEND=marlin ;;
  8) ROLLOUT_EXPERT_DTYPE=fp8; ROLLOUT_MOE_BACKEND=flashinfer_cutlass ;;

...
def _contains_mfsdp(module: torch.nn.Module) -> bool:
    return any(
        callable(getattr(child, "iter_persistent_shards", None))
...
class MegatronLiteEngine(BaseEngine):
    ...
    def save_checkpoint(
        ...
        **kwargs,
        ...
        self._require_initialized()
        use_dcp = bool(kwargs.pop("use_dcp", not _contains_mfsdp(self.module)))

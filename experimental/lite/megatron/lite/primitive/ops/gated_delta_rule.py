...
from megatron.lite.primitive.ops.fla_l2norm import HAS_FLA as _HAS_FLA_L2NORM
from megatron.lite.primitive.ops.fla_l2norm import fixed_l2norm as _fla_l2norm

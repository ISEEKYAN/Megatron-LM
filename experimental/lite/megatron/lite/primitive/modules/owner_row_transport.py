...
"""Fixed-capacity owner transport from NVIDIA-NeMo/Automodel@8a646a739.

Matches the verified Qwen3.8 owner transport. Uneven row boundaries replace
uniform division only in the sorted-owner validation. No table is transported.
"""

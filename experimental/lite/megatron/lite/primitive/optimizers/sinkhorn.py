...
class Sinkhorn(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        torch.optim.Optimizer.__init__(self, params, dict(lr=lr, multiplier=1.0))
    ...
    from .staged_update import state_dict as _base_state_dict
    from .staged_update import step
